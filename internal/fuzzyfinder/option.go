...
// WithHotkey reserves a rune as an action key. Pressing it returns ErrHotkey
// and the index of the highlighted item instead of adding it to the query.
func WithHotkey(r rune) Option {
	return func(o *opt) {
		o.hotkey = r
	}
}
